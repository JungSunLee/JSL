...
public class Channel_kbs2Activity extends Activity {

	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
	    super.onCreate(savedInstanceState);
	    setContentView(R.layout.activity_channel_kbs2);
	    ...
	    button_channelstart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent_channelstart = new Intent(Channel_kbs2Activity.this, Quiz_kbs2Activity01.class);
	    ...
	    button_channelexit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent_channelexit = new Intent(Channel_kbs2Activity.this, ChannelselActivity.class);
