...
public class Channel_sbsActivity extends Activity {

	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
	    super.onCreate(savedInstanceState);
	    setContentView(R.layout.activity_channel_sbs);
	    ...
	    button_channelstart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent_channelstart = new Intent(Channel_sbsActivity.this, Quiz_sbsActivity01.class);
	    ...
	    button_channelexit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent_channelexit = new Intent(Channel_sbsActivity.this, ChannelselActivity.class);
